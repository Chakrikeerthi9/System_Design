  ...
  return (
    <article
      ...
      style={{
        ...
        transition: `opacity .7s ease ${index * 80}ms, transform .7s ease ${index * 80}ms, box-shadow .3s ease, transform .3s ease`,
        boxShadow: hov
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-title b   { font-weight: 400; font-family: var(--font-b); font-weight: 700; }
        ...
        .link:hover {
          ...
          box-shadow: 0 6px 20px rgba(79,82,232,.12);
        }
        ...
        .sc-key  { font-size: 13px; color: var(--ink3); font-weight: 400; }
        ...
        .sc-stack { font-family: var(--font-m); font-size: 10px; color: var(--ink3); letter-spacing: .02em; }
        .sc-role {
          margin-top: 16px;
          ...
          color: var(--green); letter-spacing: .04em; font-weight: 500;
        }
        ...
        .section-label {
          font-family: var(--font-m); font-size: 10px;
          color: var(--ink4); letter-spacing: .2em;
        ...
        .section-pill {
          ...
          border: 1px solid #d0d3ff; border-radius: 999px;
        ...
        .card-foot {
          ...
          padding-top: 12px; border-top: 1px solid var(--bg);
        }
        .card-topic {
          font-family: var(--font-m); font-size: 9px;
        ...
        .card-arrow {
          font-family: var(--font-m); font-size: 10px; color: var(--ink3);
        ...
        .slot-num {
          font-family: var(--font-d); font-size: 26px; font-style: italic;
          color: var(--border2); letter-spacing: -.03em; line-height: 1;
        }
        .slot-txt {
          font-family: var(--font-m); font-size: 9px;
          color: var(--ink4); letter-spacing: .16em; text-transform: uppercase;
        }
        ...
        .overlay {
          ...
          display: flex; align-items: stretch; padding: 16px;
        ...
        .drawer {
          ...
          border: 1px solid var(--border);
          border-radius: var(--r-lg);
          box-shadow: 0 32px 80px rgba(0,0,0,.18), 0 8px 32px rgba(0,0,0,.08);
        ...
        .d-btn {
          ...
          transition: all .2s; cursor: pointer; letter-spacing: .03em;
          box-shadow: 0 1px 3px rgba(0,0,0,.05);
        }
        ...
        .footer span {
          font-family: var(--font-m); font-size: 10px;
          color: var(--ink4); letter-spacing: .04em;
        }
      ...
      <nav className={`nav ${scrolled ? "up" : ""}`}>
        ...
        <div className="nav-chip">
          ...
          <span style={{ fontFamily: "var(--font-m)", fontSize: 11, color: "var(--ink3)", letterSpacing: ".02em" }}>
            <b style={{ color: "var(--ink2)" }}>{projects.length}</b> / 15 live
          </span>
        </div>
      </nav>
      ...
      <main className="page">
        ...
        <section className="hero">
          ...
          <div className="hero-grid">
            <div>
              ...
              <div className="links">
                <a href={about.github}    target="_blank" rel="noreferrer" className="link">GitHub ↗</a>
                <a href={about.linkedin}  target="_blank" rel="noreferrer" className="link">LinkedIn ↗</a>
                <a href={about.portfolio} target="_blank" rel="noreferrer" className="link">Portfolio ↗</a>
              </div>
            </div>
            ...
            <div className="stat-card">
              ...
              <div className="sc-row">
                ...
                <span className="sc-val">{projects.length}<sup>/{15}</sup></span>
              </div>
              <div className="sc-row">
        ...
        <div className="section-row">
          ...
          <span className="section-pill">{projects.length} of 15 built</span>
        </div>
        ...
        <div className="grid">
          ...
          {Array.from({ length: 15 - projects.length }).map((_, i) => (
            <Slot key={i} num={projects.length + i + 1} />
          ))}
        </div>

        {/* FOOTER */}
        <footer className="footer">
          <span>© 2025 {about.name} · System Design Series</span>
